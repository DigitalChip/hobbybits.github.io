...
![Traefik reverse proxy](img\traefik.jpg)

## Введение для будущих инженеров
...
В Traefik 3 статическую конфигурацию (базовые настройки самого Traefik) можно задавать через YAML-файл, а не через аргументы командной строки, как этобыло в предыдущих версиях. Это более современный и гибкий подход.
